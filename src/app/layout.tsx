  ...
  return (
    <html lang="en">
      <body className={inter.className}>
       <div className=" p-1  ">
         {/* Header */}
         <div className="flex max-w-md sticky z-10  bg-white border border-gray-200 rounded  top-0  mx-auto items-center justify-between p-4">
        ...
        {/* Bottom Navigation */}
        <div className="flex max-w-md mx-auto z-10 bg-gray-50 sticky bottom-0 gap-x-3  justify-between px-4 py-1 border border-gray-200 rounded">
